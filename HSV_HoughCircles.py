...
class Camera_Process:
    ...
    def make_hsv_adjustment(self):
        ...
        cv2.createTrackbar('Low_H', self.Control_Window_Name, self.Low_H, 255, self.nothing) #Hue (0 - 179)
        cv2.createTrackbar('High_H', self.Control_Window_Name, self.High_H, 255, self.nothing)
        cv2.createTrackbar('Low_S', self.Control_Window_Name, self.Low_S, 255, self.nothing) #Saturation (0 - 255)
        cv2.createTrackbar('High_S', self.Control_Window_Name, self.High_S, 255, self.nothing)
        cv2.createTrackbar('Low_V', self.Control_Window_Name, self.Low_V, 255, self.nothing) #Value (0 - 255)
